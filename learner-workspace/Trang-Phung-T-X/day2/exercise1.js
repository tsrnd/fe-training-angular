...
let newStudent = students.map(student => {
  if (student.name === 'Huynh Thi B') {
    return { name: student.name, age: 25 };
  }
  return student
});
...
// solution3
console.log(ageStudents.reduce(function (accumulator, currentValue, currentIndex, array) {
...
//solution2
let checkStudent = students.some(student => student.name === 'Le Van D')
