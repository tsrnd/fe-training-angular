...
export class ApiService {
  ...
  */
  ...
  post(url: string, params?: any): Observable<any> {
    return this.http.post("http://localhost:4200" + url, params).pipe(
      catchError(this.handleError)
    );
  }
  ...
  */
  put(url: string, params?: any): Observable<any> {
    return this.http.put("http://localhost:4200" + url, params).pipe(
      catchError(this.handleError)
    );
  }
  ...
  */
  getConfigResponse(url: string): Observable<HttpResponse<any>> {
    return this.http.get("http://localhost:4200" + url, { observe: 'response' }).pipe(
      catchError(this.handleError)
    );
  }
